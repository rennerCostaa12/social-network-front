...
export const Post = ({}: PostProps) => {
  return (
    <Card className="max-w-[900px] relative self-center">
      ...
      <CardContent>
        <img
          src="/img-post-default.svg"
          alt="Design"
          className="w-full rounded-lg object-cover"
        />

        <div className="mt-2 flex flex-wrap gap-1 max-h-[px] overflow-auto">
          <small className="bg-black text-white p-1 rounded-lg">#futebol</small>
          <small className="bg-black text-white p-1 rounded-lg">#cozinha</small>
