...
import { ListCommentsFeedProps } from "./types";
...
import { useListComments } from "./useListCommentsFeed";

export const ListCommentsFeed = ({
  data,
  setVisibleModalComments,
  setCountComments
}: ListCommentsFeedProps) => {
        ...
        data.map((value) => {
          return (
            ...
            >
              ...
              <div className="w-full max-sm:flex flex-row items-center">
                <audio
                  className="w-full"
                  controls
                  src={value.comment}
