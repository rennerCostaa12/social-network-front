...
export const ButtonSavedPostFeed = ({ isSaved, idPost, setIsSavedPost }: ButtonSavedPostProps) => {
  const { handleRemovePost, handleSavePost } = useButtonSavedPost({ setIsSavedPost });
